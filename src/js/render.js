/* ============ render.js — outline → reveal.js DOM (spec FR-RENDER) ============
...
(function (SF) {
  ...
  function buildAllSections(opts) {
    ...
    if (!o.slides.length || o.slides[0].layout !== "title") {
  ...
  SF.render = { init, renderPreview, buildAllSections, buildSlideSection, getDeck: () => deck };
})(window.SF);
